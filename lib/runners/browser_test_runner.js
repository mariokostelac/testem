...
BrowserTestRunner.prototype = {
    ...
    return new Bluebird.Promise(function(resolve) {
      ...
      if (this.socket) {
        ...
        this.launcher.start().then(function(browserProcess) {
          ...
          console.log(`#${this.process.pid} START`);
  ...
  exit: function() {
    ...
    console.log(`#${this.process.pid} SENDING KILL`);
  ...
  onProcessExit: function(code) {
    ...
    this.onProcessExitTimer = setTimeout(function() {
      console.log(`#${browserProcess.pid} EXITED FINISHED_FLAG=${self.finished}`);
      if (self.finished) {
        return;
      }
  ...
  finish: function() {
    ...
    this.finished = true;
    console.log(`#${this.process.pid} FINISHED FLAG FLIP ${this.finished}`);
    if (this.socket) {
      console.log(`#${this.process.pid} SOCKET SEND FINISH`);
